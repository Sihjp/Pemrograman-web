...
<body>
    ...
    <div class="container pt-5 pb-5 m-20">
        ...
        <form method="POST" action="proses_kontak.php">
            ...
            <p>Hobby</p>
            <div class="form-check">
                <input type="checkbox" id="hobby1" name="hobby[]" value="Reading" class="form-check-input">
                <label for="hobby1" class="form-check-label">Reading</label><br>
                <input type="checkbox" id="hobby2" name="hobby[]" value="Makan" class="form-check-input">
                <label for="hobby2" class="form-check-label">Makan</label><br>
                <input type="checkbox" id="hobby3" name="hobby[]" value="Rizzing" class="form-check-input">
                <label for="hobby3" class="form-check-label">Rizzing</label>
            </div><br>

            <p>Birthday</p>
            <div class="date">
            <input id="startDate" id="date" name="bday" class="form-control" type="date" />
