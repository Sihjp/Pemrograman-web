    ...
    <section>
        <div class="container-fluid d-flex flex-column align-items-center justify-content-center min-vh-100">
            ...
            <div class="text-center">
                <img src="OIP.jfif" alt="Sacabambaspis" class="img-fluid img-nah">
            </div>
            <!-- Teks di Bawah Gambar -->
            <div class="text-center mt-3">
                <h5>Sacabambaspis Muncul Kembali!</h5>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum interdum, 
                    ...
                    In at libero sed nunc venenatis imperdiet sed ornare turpis. Donec vitae dui eget tellus gravida venenatis. Integer fringilla congue eros non fermentum. 
